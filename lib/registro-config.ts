...
const PERSONA_PEP: Campo[] = [
  ...
  { id: "num_doc", label: "N° de documento", tipo: "text", requerido: true },
  {
    id: "nacionalidad",
...
export const FORM_REGISTRO: Seccion[] = [
  ...
  },
  {
    ...
    campos: [
      ...
      { id: "cci_dolares", label: "Código CCI (dólares)", tipo: "text" },
      {
        id: "detracciones",
  ...
  },
  {
    ...
    campos: [
      ...
      { id: "ref2_correo", label: "Referencia 2 — Correo", tipo: "email" },
    ],
  },
  {
    id: "rep_legal",
